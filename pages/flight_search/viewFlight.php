...
$stmt = "SELECT * FROM flight WHERE id = " . $flightId;
...
<textarea id="messageContent" name="messageContent" placeholder="Type message to '.$row["companyName"].'" cols="30" rows="6"
        style="resize: none;"></textarea>
<div class="outer">
  <button onclick="testFunc(\''.$row["companyName"].'\')" class="blueButton inner">Send Message</button>
  <button onclick="testFunc2('.$flightId.')" class="blueButton inner">Pay</button>
</div>
';
?>
